...
_SECRET_KEYS = (
    ...
    "ENABLE_ANSWER_SCHEMA", "ANSWER_MAX_OUTPUT_TOKENS",
    "ENABLE_SCOPE_GATE", "SCOPE_GATE_LLM", "ENABLE_MODEL_KNOWLEDGE", "MAX_TOOL_ROUNDS",
    "ABSTAIN_ON_DENSE_FAILURE", "ABSTAIN_BM25_REFERENCE", "CONTEXT_MIN_DOCS",
    "RULEBOOK_PDF_URL",
    "APP_ACCESS_PIN",
    # 신규 도구. 여기 없으면 로컬은 멀쩡하고 Cloud 배포본에서만 조용히 꺼진다.
    "KBO_SCHEDULE_LOOKBACK_DAYS",
    "ENABLE_SCHEDULE_TOOL", "ENABLE_PLACES", "ENABLE_PLACES_MAP", "ENABLE_HIGHLIGHTS",
    "GOOGLE_MAPS_EMBED_API_KEY", "YOUTUBE_KBO_API_KEY",
    ...
    "YOUTUBE_DAILY_UNIT_BUDGET", "YOUTUBE_UPLOADS_MAX_RESULTS",
    "YOUTUBE_UPLOADS_TTL_SECONDS", "YOUTUBE_NEGATIVE_TTL_SECONDS",
    "YOUTUBE_CHANNEL_TTL_SECONDS",
)
